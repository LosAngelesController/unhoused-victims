...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    ...
    map.on("load", () => {
      ...
      map.loadImage("/dog512.png", (error, image: any) => {
    ...
    <div className="flex flex-col h-full w-screen absolute">
      <Head>
        ...
        <meta
          name="twitter:title"
          key="twittertitle"
          content="City of LA Parks and Dog Parks | Map and Land Analysis"
        ></meta>
        <meta
          name="twitter:description"
          key="twitterdesc"
          content="City of LA Parks visualized. See all parks and observe inequities in park distribution."
        ></meta>
        <meta
          name="twitter:image"
          key="twitterimg"
